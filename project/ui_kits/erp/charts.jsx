...
function LineChart({ data, color = 'var(--green-500)', height = 180, labels = [], yTicks = [], dotted = false }) {
...
function DonutChart({ segments, size = 168, thickness = 30 }) {
...
function BarChart({ data, height = 180, labels = [], ranks = [] }) {
...
window.RTLCharts = { LineChart, DonutChart, BarChart };
