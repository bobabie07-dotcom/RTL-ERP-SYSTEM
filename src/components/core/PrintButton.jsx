...
export function PrintButton({ title = 'Report', orientation = 'auto' }) {
...
export function PrintPageHeader({ title }) {
  ...
  return (
    <div className="print-only print-document-header" style={{ display: 'none', marginBottom: 24 }}>
      <div style={{
        ...
        <div style={{ marginLeft: 'auto', textAlign: 'right' }}>
          ...
          <div style={{ fontSize: 12, color: '#6b7280', marginTop: 3 }}>Generated: {dateStr} {timeStr}</div>
          <div style={{ fontSize: 12, color: '#6b7280', marginTop: 2 }}>Generated By: {generatedBy}</div>
        </div>
      </div>
    </div>
  );
...
export function PrintPageFooter() {
  ...
  return (
    <div className="print-only print-document-footer" style={{ display: 'none' }}>
